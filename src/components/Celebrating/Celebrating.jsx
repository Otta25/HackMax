...
function Celebrating() {
  return (
    <div className='celebrating w-full h-[60vh] flex items-center justify-center desktop:items-start desktop:justify-start desktop:mt-[5vh] pt-10 desktop:pl-[70px]'>
        <div className='flex flex-col items-center w-[90%] desktop:items-start desktop:text-left desktop:w-[30vw] text-textPrimary'>
            ...
            <Link className='p-4 mb-10 bg-[rgba(100,100,100,0.4)] rounded-md w-[200px] flex items-center justify-center mt-5 hover:bg-[#] hover:outline outline-[#4205c5]'>Mas informacion</Link>
        </div>
    </div>
  )
}
